...
public abstract class AudioClip {
    ...
    public static AudioClip create(byte[] arrby, int n, int n2, int n3, int n4, int n5) throws IllegalArgumentException {
        return AudioClipProvider.getProvider().create(arrby, n, n2, n3, n4, n5);
    }
