...
public abstract class WCGraphicsContext {
    ...
    public abstract void fillRect(float var1, float var2, float var3, float var4, Integer var5);
    ...
    public abstract void fillRoundedRect(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10, float var11, float var12, int var13);
    ...
    public abstract void drawFocusRing(int var1, int var2, int var3, int var4, int var5);
    ...
    public abstract void setShadow(float var1, float var2, float var3, int var4);
