...
extends PrRenderer {
    ...
    public static synchronized PSWRenderer createJSWInstance(Screen screen) {
        ...
        try {
            ...
            RendererDelegate rendererDelegate = (RendererDelegate)class_.newInstance();
    ...
    private EffectPeer createPlatformPeer(FilterContext filterContext, String string, int n) {
        ...
        try {
            ...
            System.err.println("Error: " + (Object)((Object)this.getAccelType()) + " peer not found for: " + string + " due to error: " + exception.getMessage());
            return null;
        }
        return effectPeer;
    }
