...
public final class PiscesRenderer {
    ...
    public void setTexture(int n, int[] arrn, int n2, int n3, int n4, Transform6 transform6, boolean bl, boolean bl2) {
        this.inputImageCheck(n2, n3, 0, n4, arrn.length);
        this.setTextureImpl(n, arrn, n2, n3, n4, transform6, bl, bl2);
    }
    ...
    public void drawImage(int n, int n2, int[] arrn, int n3, int n4, int n5, int n6, Transform6 transform6, boolean bl, int n7, int n8, int n9, int n10, int n11, int n12, int n13, int n14, int n15, int n16, int n17, int n18, boolean bl2) {
        this.inputImageCheck(n3, n4, n5, n6, arrn.length);
        this.drawImageImpl(n, n2, arrn, n3, n4, n5, n6, transform6, bl, n7, n8, n9, n10, n11, n12, n13, n14, n15, n16, n17, n18, bl2);
    }
