...
implements PrinterImpl {
    ...
    private static void initPrefinedMediaMaps() {
        ...
        if (predefinedPaperMap == null) {
            ...
            hashMap.put((MediaTray)((Object)MediaSizeName.NA_LETTER), (PaperSource)Paper.NA_LETTER);
            hashMap.put((MediaTray)((Object)MediaSizeName.TABLOID), (PaperSource)Paper.TABLOID);
            hashMap.put((MediaTray)((Object)MediaSizeName.NA_LEGAL), (PaperSource)Paper.LEGAL);
            hashMap.put((MediaTray)((Object)MediaSizeName.EXECUTIVE), (PaperSource)Paper.EXECUTIVE);
            hashMap.put((MediaTray)((Object)MediaSizeName.NA_8X10), (PaperSource)Paper.NA_8X10);
            hashMap.put((MediaTray)((Object)MediaSizeName.MONARCH_ENVELOPE), (PaperSource)Paper.MONARCH_ENVELOPE);
            hashMap.put((MediaTray)((Object)MediaSizeName.NA_NUMBER_10_ENVELOPE), (PaperSource)Paper.NA_NUMBER_10_ENVELOPE);
            hashMap.put((MediaTray)((Object)MediaSizeName.ISO_A0), (PaperSource)Paper.A0);
            hashMap.put((MediaTray)((Object)MediaSizeName.ISO_A1), (PaperSource)Paper.A1);
            hashMap.put((MediaTray)((Object)MediaSizeName.ISO_A2), (PaperSource)Paper.A2);
            hashMap.put((MediaTray)((Object)MediaSizeName.ISO_A3), (PaperSource)Paper.A3);
            hashMap.put((MediaTray)((Object)MediaSizeName.ISO_A4), (PaperSource)Paper.A4);
            hashMap.put((MediaTray)((Object)MediaSizeName.ISO_A5), (PaperSource)Paper.A5);
            hashMap.put((MediaTray)((Object)MediaSizeName.ISO_A6), (PaperSource)Paper.A6);
            hashMap.put((MediaTray)((Object)MediaSizeName.C), (PaperSource)Paper.C);
            hashMap.put((MediaTray)((Object)MediaSizeName.ISO_DESIGNATED_LONG), (PaperSource)Paper.DESIGNATED_LONG);
            hashMap.put((MediaTray)((Object)MediaSizeName.JIS_B4), (PaperSource)Paper.JIS_B4);
            hashMap.put((MediaTray)((Object)MediaSizeName.JIS_B5), (PaperSource)Paper.JIS_B5);
            hashMap.put((MediaTray)((Object)MediaSizeName.JIS_B6), (PaperSource)Paper.JIS_B6);
            hashMap.put((MediaTray)((Object)MediaSizeName.JAPANESE_POSTCARD), (PaperSource)Paper.JAPANESE_POSTCARD);
