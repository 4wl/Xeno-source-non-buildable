...
implements PlatformImage {
    ...
    extends Accessor<I> {
        ...
        BaseAccessor(javafx.scene.image.PixelFormat<I> pixelFormat, PixelGetter<I> pixelGetter, PixelSetter<I> pixelSetter, I i, int n2) {
            ...
            this.theBuffer = i;
            this.pixelElems = n2;
            this.scanlineElems = ((Image)n).scanlineStride / ((Image)n).pixelFormat.getDataType().getSizeInBytes();
            this.offsetElems = ((Image)n).minY * this.scanlineElems + ((Image)n).minX * n2;
        }
