...
implements PixelSource {
    ...
    public synchronized Pixels getUnusedPixels(int n, int n2, float f) {
        ...
        while (n3 < this.saved.size()) {
            ...
            if (pixels.getWidthUnsafe() == n && pixels.getHeightUnsafe() == n2 && pixels.getScaleUnsafe() == f) {
                return pixels;
            }
            this.saved.remove(n3);
        ...
        weakReference = Application.GetApplication().createPixels(n, n2, intBuffer, f);
