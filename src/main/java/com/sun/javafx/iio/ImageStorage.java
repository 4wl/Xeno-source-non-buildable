...
public class ImageStorage {
    ...
    public static ImageFrame[] loadAll(InputStream inputStream, ImageLoadListener imageLoadListener, int n, int n2, boolean bl, float f, boolean bl2) throws ImageStorageException {
        ...
        arrimageFrame = ImageStorage.loadAll(imageLoader, n, n2, bl, f, bl2);
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static ImageFrame[] loadAll(String string, ImageLoadListener imageLoadListener, int n, int n2, boolean bl, float f, boolean bl2) throws ImageStorageException {
        ...
        block16: {
            ...
            try {
                ...
                if (imageLoader != null) {
                    arrimageFrame = ImageStorage.loadAll(imageLoader, n, n2, bl, f2, bl2);
                    break block16;
                }
                throw new ImageStorageException("No loader for image data");
            }
    ...
    private static ImageFrame[] loadAll(ImageLoader imageLoader, int n, int n2, boolean bl, float f, boolean bl2) throws ImageStorageException {
        ImageFrame[] arrimageFrame = null;
