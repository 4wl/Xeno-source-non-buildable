...
extends NGNode {
    ...
    public void setImageBuffer(Buffer buffer, int n, int n2, int n3, int n4, float f, float f2, int n5, int n6) {
        this.bufferData = new BufferData(buffer, n5, n, n2, n3, n4, f, f2, n6);
    ...
    private static class BufferData {
        ...
        BufferData(Buffer buffer, int n, int n2, int n3, int n4, int n5, float f, float f2, int n6) {
        ...
        BufferData copyWithBounds(int n, int n2, int n3, int n4, float f, float f2) {
            return new BufferData(this.srcbuffer, this.linestride, n, n2, n3, n4, f, f2, this.scale);
        }
    }
}
