...
public final class StyleManager {
    ...
    private void cleanUpImageCache(String string) {
        ...
        synchronized (object) {
            ...
            for (Map.Entry<String, Image> image : set) {
                String string4 = image.getKey();
            ...
            for (int i = 0; i < n3; ++i) {
                Image image = this.imageCache.remove(arrstring[i]);
            }
        }
    }
    ...
    private List<StylesheetContainer> gatherParentStylesheets(Parent parent) {
        ...
        List list = parent.impl_getAllParentStylesheets();
    ...
    private List<StylesheetContainer> gatherSceneStylesheets(Scene scene) {
        ...
        synchronized (object) {
            CssError.setCurrentScene(scene);
            List<StylesheetContainer> list = this.processStylesheets((List<String>)observableList, scene.getRoot());
            CssError.setCurrentScene(null);
            return list;
        }
    }
            ...
            if (cache != null) {
                ...
                if (bl6 || bl5) {
                    ...
                    if (stylesheetContainer.selectorPartitioning != null) {
                        ...
                        List<Selector> list3 = stylesheetContainer.selectorPartitioning.match(string7, string6, (Set<StyleClass>)((Object)this.key.styleClasses));
                ...
                if (bl) {
                    ...
                    if (((StylesheetContainer)object3).selectorPartitioning != null) {
                        ...
                        List<Selector> list5 = ((StylesheetContainer)object3).selectorPartitioning.match(string7, string6, (Set<StyleClass>)((Object)this.key.styleClasses));
                ...
                if (!list2.isEmpty()) {
                    ...
                    for (int i = 0; i < n5; ++i) {
                        ...
                        if (stylesheetContainer == null || stylesheetContainer.selectorPartitioning == null) continue;
                        List<Selector> list6 = stylesheetContainer.selectorPartitioning.match(string7, string6, (Set<StyleClass>)((Object)this.key.styleClasses));
    ...
    private static class Cache {
        ...
        private StyleMap getStyleMap(CacheContainer cacheContainer, Node node, Set<PseudoClass>[] arrset, boolean bl) {
            ...
            for (int i = 0; i < n2; ++i) {
                ...
                if (!((Selector)object).applies((Styleable)node, arrset, 0)) continue;
                int n3 = i / 64;
