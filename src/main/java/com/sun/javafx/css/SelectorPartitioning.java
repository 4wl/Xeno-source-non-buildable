...
public final class SelectorPartitioning {
    ...
    void partition(Selector selector) {
        ...
        PartitionKey partitionKey = n != 0 ? new PartitionKey(object) : null;
        String string = simpleSelector.getName();
        boolean bl = string != null && !string.isEmpty();
        PartitionKey partitionKey2 = bl ? new PartitionKey(string) : null;
        Set<StyleClass> set = simpleSelector.getStyleClassSet();
        boolean bl2 = set != null && set.size() > 0;
        PartitionKey partitionKey3 = bl2 ? new PartitionKey(set) : null;
    ...
    List<Selector> match(String string, String string2, Set<StyleClass> set) {
        boolean bl = string != null && !string.isEmpty();
        PartitionKey partitionKey = bl ? new PartitionKey(string) : null;
        ...
        PartitionKey partitionKey3 = bl3 ? new PartitionKey(set) : null;
            ...
            switch (n) {
                ...
                case 7: {
                    ...
                    if (partition != null) {
                        ...
                        do {
                            if ((slot = (Slot)partition.slots.get(partitionKey4)) == null) continue;
