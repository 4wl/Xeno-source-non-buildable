...
extends Toolkit {
    ...
    public ImageLoader loadImage(String string, int n, int n2, boolean bl, boolean bl2) {
        return new PrismImageLoader2(string, n, n2, bl, this.getMaxRenderScale(), bl2);
    }
    ...
    protected Object createImagePatternPaint(ImagePattern imagePattern) {
        ...
        return new com.sun.prism.paint.ImagePattern((com.sun.prism.Image)imagePattern.getImage().impl_getPlatformImage(), (float)imagePattern.getX(), (float)imagePattern.getY(), (float)imagePattern.getWidth(), (float)imagePattern.getHeight(), imagePattern.isProportional(), Toolkit.getPaintAccessor().isMutable((javafx.scene.paint.Paint)imagePattern));
    }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (arrn != null) {
                        ...
                        if (quantumImage.rt.readPixels(intBuffer, quantumImage.rt.getContentX(), quantumImage.rt.getContentY(), n3, n4)) {
