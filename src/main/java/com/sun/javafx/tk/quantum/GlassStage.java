...
implements TKStage {
    ...
    public final void setSecurityContext(AccessControlContext accessControlContext) {
        ...
        this.accessCtrlCtx = (AccessControlContext)javaSecurityAccess.doIntersectionPrivilege(() -> AccessController.getContext(), accessControlContext2, accessControlContext);
    }
