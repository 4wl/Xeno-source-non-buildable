...
public abstract class Toolkit {
                ...
                block5: {
                    block4: {
                        try {
                            ...
                            if (!bl) break block4;
                            System.err.println("Error: failed to load msvcr120.dll : " + throwable);
                        }
                    }
                    try {
                        ...
                        if (!bl) break block5;
                        System.err.println("Error: failed to load msvcp120.dll : " + throwable);
                    }
                }
                return null;
            });
    ...
    public InputStream getInputStream(String string, Class class_) throws IOException {
        return string.startsWith("http:") || string.startsWith("https:") || string.startsWith("file:") || string.startsWith("jar:") ? new URL(string).openStream() : class_.getResource(string).openStream();
    }
