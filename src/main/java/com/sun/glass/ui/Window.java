...
public abstract class Window {
    ...
    public void setBounds(int n, int n2, boolean bl, boolean bl2, int n3, int n4, int n5, int n6, float f, float f2) {
        Application.checkEventThread();
        this.checkNotClosed();
        this._setBounds(this.ptr, n, n2, bl, bl2, n3, n4, n5, n6, f, f2);
    }

    public void setPosition(int n, int n2) {
        Application.checkEventThread();
        this.setBounds(n, n2, true, true, 0, 0, 0, 0, 0.0f, 0.0f);
    }

    public void setSize(int n, int n2) {
        Application.checkEventThread();
        this.setBounds(0, 0, false, false, n, n2, 0, 0, 0.0f, 0.0f);
    }

    public void setContentSize(int n, int n2) {
        Application.checkEventThread();
        this.setBounds(0, 0, false, false, 0, 0, n, n2, 0.0f, 0.0f);
    }
    ...
    private void handleWindowEvent(long l, int n) {
